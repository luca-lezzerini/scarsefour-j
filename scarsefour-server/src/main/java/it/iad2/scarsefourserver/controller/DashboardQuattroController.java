...
public class DashboardQuattroController {
    ...
    @ResponseBody
    public RispostaEanDtoQuattro verificaEanAction(@RequestBody RichiestaEanDto dto) {
        return dashboardquattro.verificaEanAction(dto.getBarcode(), dto.getScontrino());
    }
}
